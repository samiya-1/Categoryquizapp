...
import 'package:quizapp/controller/SportsController.dart';
import 'package:quizapp/view/ScoreResult/ScoreResultBoard.dart';


class SportsQuizHome extends StatefulWidget {
  const SportsQuizHome({super.key});

  @override
  State<SportsQuizHome> createState() => _SportsQuizHomeState();
}

class _SportsQuizHomeState extends State<SportsQuizHome> {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  SportsController
                      .sportsQuestionList[currentQuestionIndex].Question,
                    ...
                    onTap: () {
                      ...
                      if (selectedanswerindex == null) {
                        ...
                        if (selectedanswerindex ==
                            SportsController
                                .sportsQuestionList[currentQuestionIndex]
                                .correctIndex) {
                          rightAnswerCount++;
                        }
                        setState(() {});
              ...
              InkWell(
                onTap: () {
                    ...
                    skippedAnswerCount++;
                      ...
                      SportsController
                          .sportsQuestionList[currentQuestionIndex].correctIndex) {
                    wrongAnswerCount++;
                  }
                  if (currentQuestionIndex <
                      SportsController.sportsQuestionList.length - 1) {
